...
import { modelSettingsState, saveModelSettings, ModelSettings } from '../store/modelSettings'
...
export const useModelSettings = () => {
  ...
  const updateModelSetting = useCallback((key: keyof ModelSettings, value: string | number) => {
